// Alternative version using Functions v1 (doesn't require Eventarc)
// If Eventarc permissions continue to fail, replace users.js with this version
// and update index.js to use: const users = require("./users.v1");
 ...
 * 
 * This uses Functions v1 syntax which doesn't require Eventarc permissions.
 */
