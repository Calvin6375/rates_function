...
- **Sandbox:** Function `partnerSandbox` — same route shapes, static public `X-API-KEY`, in-memory mocks (`http/partnerSandboxHttp.js`, `services/b2bSandboxPartnerService.js`). See [`B2B_SANDBOX.md`](./B2B_SANDBOX.md).
